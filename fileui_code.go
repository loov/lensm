...
func (ui CodeUIStyle) Layout(gtx layout.Context) layout.Dimensions {
...

	{
		...
		if distance := ui.asm.gesture.Update(gtx.Metric, gtx.Source, gtx.Now, gesture.Vertical, image.Rect(0, -1000, 1, 1000)); distance != 0 {
...

	{
		...
		if distance := ui.src.gesture.Update(gtx.Metric, gtx.Source, gtx.Now, gesture.Vertical, image.Rect(0, -1000, 1, 1000)); distance != 0 {
